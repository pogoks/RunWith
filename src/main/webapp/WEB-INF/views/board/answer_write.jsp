					  ...
					  <form action="<c:url value='/question/answerWrite'/>" method="post" name="answerWriteForm">
		    			...
		    			<table class= "table table-stripped" style= "text-align: center; boarder: 1px solid #dddddd">
			    	    	<thead>
				    	    	...
				    	    	<tr>
					    			<td><input type="text" id="answerTitle" name="answerTitle" class="form-control" placeholder="답변 제목을 입력하세요." maxlength="100" ></td>
					    	...
					    	<tbody>
					    		...
					    		<tr>
					    			<td><textarea class="form-control" id="answerContent" name="answerContent" placeholder="답변 내용을 입력하세요." maxlength="2048" style= "height:350px; resize:none;" ></textarea></td>
					    		</tr>
					    	</tbody>
		    	    	</table>
