    		...
    		$('#modal-user-receive-message').on('click', 'a', function(e) {
    			...
    			$.ajax({
    				...
    				success: function(result) {
						...
						let str = result.userMessageContent.replaceAll("\n", "<br/>");
						
						$('#modal-message-detail-content').empty().append(str);
    		...
    		$('#modal-company-receive-message').on('click', 'a', function(e) {
    			...
    			$.ajax({
    				...
    				success: function(result) {
						...
						let str = result.companyMessageContent.replaceAll("\n", "<br/>");
						
						$('#modal-message-detail-content2').empty().append(str);
